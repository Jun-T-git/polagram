...
export class Parser extends BaseParser<Token> {
  ...
  private parseGroup(root: PolagramRoot): any | null {
  ...
  private parseFragment(root: PolagramRoot): any | null {
      const kind = 'fragment';
  ...
  private parseStatement(root: PolagramRoot): any | null {
      if (['PARTICIPANT', 'ACTOR', 'DATABASE'].includes(this.currToken.type)) {
          this.parseParticipant(root);
  ...
  private parseNote(root: PolagramRoot): any | null {
  ...
  private parseActivation(root: PolagramRoot): any | null {
  ...
  private parseMessage(root: PolagramRoot): any | null {
     ...
     // Resolve arrow style
     let type: any = 'sync';
     let style: any = { line: 'solid', head: 'arrow' };
  ...
  private parseParticipant(root: PolagramRoot) {
      ...
      let type: any = 'participant'; // Default
