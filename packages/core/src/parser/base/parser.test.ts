...
import type { Token, TokenType } from '../languages/mermaid/tokens';
...
class TestParser extends BaseParser {
  ...
  public testCurTokenIs(t: TokenType) {
    return this.curTokenIs(t);
  }
  public testPeakTokenIs(t: TokenType) {
    return this.peekTokenIs(t);
  }
  public testExpectPeek(t: TokenType) {
    return this.expectPeek(t);
  }
}
