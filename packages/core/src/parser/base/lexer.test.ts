...
import type { Token } from '../languages/mermaid/tokens';
...
class TestLexer extends BaseLexer {
  public nextToken(): Token {
    ...
    if (this.readPosition > this.input.length) {
      // fixed EOF logic for test, check base-lexer readChar behavior
  ...
  public testReadIdentifier() {
    return this.readWhile((c) => this.isLetter(c));
  }
  public testIsDigit(c: string) {
    return this.isDigit(c);
  }
  public testIsLetter(c: string) {
