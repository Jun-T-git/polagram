...
describe('UnusedCleaner', () => {
    ...
    it('keeps participants referenced in activations', () => {
        const p1 = { id: 'A', name: 'Alice', type: 'participant' as const };
        const act: ActivationNode = { kind: 'activation', participantId: 'A', action: 'activate' };
    ...
    it('keeps participants referenced in notes', () => {
        const p1 = { id: 'A', name: 'Alice', type: 'participant' as const };
        const note: NoteNode = { kind: 'note', id: 'n1', text: 'Note', position: 'over', participantIds: ['A'] };
    ...
    it('cleans up groups removing unused members', () => {
        ...
        const group = { kind: 'group' as const, id: 'g1', name: 'G', participantIds: ['A', 'B'] };
